...
import Herocar from '../assets/bluecar.png'
            ...
            <div className='max-w-7xl  mx-auto'>
                <div className='flex flex-col  lg:flex-row gap-12 lg:gap-6 h-screen lg:h-[650px] lg:items-center lg:justify-center lg:pt-0 pt-12'>
                    ...
                    <div className='lg:w-1/2 flex  flex-col px-8 space-y-5 justify-center '>
                        ...
                        initial="hidden"
                        animate="visible"
                        className='text-blue-500 text-lg lg:text-xl'>On Demand Purchase _____</motion.h3>
                        <motion.h1 
                        variants={FadeRight(0.9)}
                        initial="hidden"
                        animate="visible"
                        className='text-4xl lg:text-6xl font-bold text-white'>Experience the Thrill of <span className='text-blue-500'>Super Cars</span></motion.h1>
                        <motion.p
                        ...
                        <div className='flex gap-3'>
                            ...
                            initial="hidden"
                            animate="visible"
                            className='bg-blue-500 text-white px-3 lg:px-4 py-2 rounded-full flex items-center font-semibold'>Explore Models <ChevronRight /></motion.button>
                            <motion.button
                ...
                className='bg-white border border-gray-300 shadow-lg hidden lg:block rounded-md absolute -bottom-10 left-auto w-[1050px] mx-auto p-4'>
                    <div className='flex gap-3 items-center '>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <button className='bg-blue-500 transition-all ease-in rounded-sm text-white hover:bg-black hover:text-white px-3 h-8 py-1 '>Order Now</button>
                        </div>
                    </div>
