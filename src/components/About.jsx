    ...
    <div className='max-w-7xl  mx-auto'>
        <div className='flex flex-col lg:flex-row gap-6 h-[650px] items-center justify-center'>
            ...
            <div className='lg:w-1/2  flex flex-col px-8 space-y-5 justify-center '>
                ...
                className='text-4xl lg:text-6xl font-bold'>Experience the Thrill of <span className='text-blue-500'>Super Cars</span></motion.h1>
                <motion.p 
                initial={{opacity:0, x:200}}
                whileInView={{opacity:1, x:0}}
                ...
                <div className='flex gap-3'>
                    ...
                    className='bg-blue-500 text-white px-4 py-2 rounded-full flex items-center font-semibold'>Explore Models <ChevronRight /></motion.button>
                    <motion.button 
                    initial={{opacity:0, x:200}}
                    whileInView={{opacity:1, x:0}}
                    transition={{duration:2, delay:1}}
                    className='bg-white border border-blue-500 text-blue-500 lg:px-4 lg:py-2 px-2 py-2 rounded-full'>Book a Test Drive</motion.button>
                </div>
